...
<div>
    <?php if(empty($_SESSION['user']['username'])): ?><a href="<?php echo U('User/login');?>">登录</a>
        ...
        <?php else: ?>
        欢迎您！ <?php echo ($_SESSION['user']['username']); ?>         <a href="/thinkphp-inaction/message-board1/index.php/Home/Index/post"><strong>发表留言</strong></a> <a href="<?php echo U('User/logout');?>">退出登录</a><?php endif; ?>
</div>
